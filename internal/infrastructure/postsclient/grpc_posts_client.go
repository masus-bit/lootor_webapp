...
func (c *GRPCPostsClient) IncrementCommentsCount(ctx context.Context, id string) (
...
func (c *GRPCPostsClient) DecrementCommentsCount(ctx context.Context, id string) (
	*microservices.CommentsCountResponse,
	error,
) {
