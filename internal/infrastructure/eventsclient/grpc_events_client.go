...
func (c *GRPCEventsClient) AddEvent(ctx context.Context, req *dto.AddEventRequest) (
	*microservices.AddEventResponse,
	error,
) {
	return c.client.AddEvent(
		ctx, &microservices.AddEventRequest{
			Action:         req.Action,
...
func (c *GRPCEventsClient) GetEvents(ctx context.Context, req *dto.GetEventsRequest) (
	*microservices.GetEventsResponse,
	error,
) {
	return c.client.GetEvents(
		ctx, &microservices.GetEventsRequest{
			Limit:             req.Limit,
			Offset:            req.Offset,
...
func (c *GRPCEventsClient) GetFilteredEvents(
	ctx context.Context,
	req *dto.GetFilteredEventsRequest,
) (*microservices.GetEventsResponse, error) {
	return c.client.GetFilteredEvents(
		ctx, &microservices.GetFilteredEventsRequest{
			Limit:             req.Limit,
			Offset:            req.Offset,
