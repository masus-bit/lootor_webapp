...
func (c *GRPCNotificationsClient) AddNotification(
	ctx context.Context,
	req *dto.NotificationsRequest,
) (*microservices.NotificationResponse, error) {

	resp, err := c.client.CreateNotification(
		ctx, &microservices.CreateNotificationRequest{
			Date:        req.Date,
...
func (c *GRPCNotificationsClient) GetAllNotifications(
	ctx context.Context,
	login, limit, offset string,
) (*microservices.GetAllNotificationsResponse, error) {
	return c.client.GetAllNotifications(
		ctx,
		&microservices.GetAllNotificationsRequest{Limit: limit, Offset: offset, UserLogin: login},
	)
}

func (c *GRPCNotificationsClient) ReadNotifications(ctx context.Context, ids []string) (
	*microservices.ReadResponse,
	error,
) {
	return c.client.ReadNotifications(
		ctx, &microservices.ReadRequest{
			Ids:    ids,
			IsRead: true,
		},
	)
...
func (c *GRPCNotificationsClient) DeleteNotification(
	ctx context.Context,
	targetID, senderLogin string,
) (*microservices.DeleteNotificationResponse, error) {
	notification, err := c.client.RemoveNotification(
		ctx, &microservices.DeleteNotificationRequest{
			TargetId:  targetID,
...
func (c *GRPCNotificationsClient) DeleteAllNotificationsByTargetID(
	ctx context.Context,
	targetID string,
) (*microservices.DeleteNotificationResponse, error) {
	return c.client.RemoveAllNotificationsByTargetId(
		ctx, &microservices.DeleteNotificationRequest{
			TargetId: targetID,
		},
	)
